...
while not crashed:
	...
	for i in range(num_play):
		if neigh[i][1] == num_play-1:
			...
			##################    PERI*DIST/AREA ALGORITHM    ################
			d0 = dist(points[neigh[i][1]],points[num_play-1])
			d2 = dist(points[neigh[i][1]],points[num_play-1])**2
			if i!=0 and i!=num_play-1:
				dn = dist(points[neigh[i][1]],points[neigh[i+1][1]])
				dp = dist(points[neigh[i][1]],points[neigh[i-1][1]])
				nu = (points[neigh[i][1]][1]-points[num_play-1][1])/d2 + (points[neigh[i][1]][1]-points[neigh[i+1][1]][1])/(peri*dn) + (points[neigh[i][1]][1]-points[neigh[i-1][1]][1])/(peri*dp) + (points[neigh[i+1][1]][0]-points[neigh[i-1][1]][0])/(2*area)
				de = (points[neigh[i][1]][0]-points[num_play-1][0])/d2 + (points[neigh[i][1]][0]-points[neigh[i+1][1]][0])/(peri*dn) + (points[neigh[i][1]][0]-points[neigh[i-1][1]][0])/(peri*dp) - (points[neigh[i+1][1]][1]-points[neigh[i-1][1]][1])/(2*area)
				beta = atan2(nu,de)
				...
				dp = dist(points[neigh[i][1]],points[neigh[i-1][1]])
				nu = (points[neigh[i][1]][1]-points[num_play-1][1])/d2 + (points[neigh[i][1]][1]-points[neigh[0][1]][1])/(peri*dn) + (points[neigh[i][1]][1]-points[neigh[i-1][1]][1])/(peri*dp) + (points[neigh[0][1]][0]-points[neigh[i-1][1]][0])/(2*area)
				de = (points[neigh[i][1]][0]-points[num_play-1][0])/d2 + (points[neigh[i][1]][0]-points[neigh[0][1]][0])/(peri*dn) + (points[neigh[i][1]][0]-points[neigh[i-1][1]][0])/(peri*dp) - (points[neigh[0][1]][1]-points[neigh[i-1][1]][1])/(2*area)
				beta = atan2(nu,de)
				...
				nu = (points[neigh[i][1]][1]-points[num_play-1][1])/d2 + (points[neigh[i][1]][1]-points[neigh[i+1][1]][1])/(peri*dn) + (points[neigh[i][1]][1]-points[neigh[num_play-1][1]][1])/(peri*dp) + (points[neigh[i+1][1]][0]-points[neigh[num_play-1][1]][0])/(2*area)
				de = (points[neigh[i][1]][0]-points[num_play-1][0])/d2 + (points[neigh[i][1]][0]-points[neigh[i+1][1]][0])/(peri*dn) + (points[neigh[i][1]][0]-points[neigh[num_play-1][1]][0])/(peri*dp) - (points[neigh[i+1][1]][1]-points[neigh[num_play-1][1]][1])/(2*area)
				beta = atan2(nu,de)
